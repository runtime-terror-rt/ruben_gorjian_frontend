  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const mappedPayload = {
        ...
        materialsCertifications: payload.materials || "",
        birthstoneTheming: payload.birthstone_notes || "",
        sampleCaptions: payload.sample_captions || "",
        ...
        googleDriveEmails: payload.drive_share_emails || "",
        primaryContactName: payload.contact_primary_name || "",
        primaryContactEmail: payload.contact_primary_email || "",
        preferredCommunication: payload.communication || "",
        authSignedAs: payload.signed_as || "",
