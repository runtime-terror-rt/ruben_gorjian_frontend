    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="space-y-6">
        <div className="space-y-2 text-center pb-4">
          <h2 className="text-xl font-bold text-white uppercase tracking-wider">Brand Publishing Authorization</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <div className="px-3 py-2 rounded-md bg-slate-800/30 border border-slate-800 text-slate-400 text-sm">
              {data.brandName || "Enter Brand Name in Step 1"}
            </div>
          </div>
        ...
        <div className="pt-8 text-center border-t border-slate-800">
          <p className="text-[10px] text-slate-600 font-medium tracking-widest uppercase">
            TALEXIA • Brand Brief • Confidential
          </p>
        </div>
      </div>
    </div>
